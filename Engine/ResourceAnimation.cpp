...
bool NodeAnimation::CalcCurrentIndex(float time)
{
	bool ret = false;

	if (current_pos_index == -1 || current_rot_index == -1 || current_scale_index == -1 || next_pos_index == -1 || next_rot_index == -1 || next_scale_index == -1)
	{
